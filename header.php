        ...
        <header class="header">
            <div class="container">
                ...
                <div class="header-right">
                    <!-- mobile menu -->
                    <a href="#" class="mobile-show-menu">MENU</a>
                    <!-- mobile menu -->
                    <div class="right-navigation-menu">
                        <a href="javascrip:void(0)"><img
                                src="<?php echo get_template_directory_uri() ?>/img/icon-marker.png" alt="">
                            Find a
                            store</a>
                    </div>
            ...
            <div class="mobile-menu-block">
                ...
                <a href="javascrip:void(0)" class="mobile-close-menu">X</a>
                <?php wp_nav_menu(
                    array(
