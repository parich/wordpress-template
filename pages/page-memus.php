                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="menu-content-wrapper">
                        ...
                        <div class="menu-type" id="beverages">
                            ...
                            <p>* เครื่องดื่มร้อนและเครื่องดื่ม Nitro มีจำหน่ายในขนาด Short (8 oz.) ในราคาที่ถูกกว่าขนาด
                                Tall (12 oz.) 15 บาท</p>
                            <div class="menu-slider">
                                <?php if ($beverages->have_posts()): ?>
                                    <?php while ($beverages->have_posts()):
                                        $beverages->the_post(); ?>
                                        <div class="menu-item">
                                            ...
                                            <div class="menu-action">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="menu-stock">
                                                            <?php the_field('stock_status'); ?>
                                                        </p>
                                                    </div>
                                                    <!-- price -->
                                                    <div class="col-6">
                                                        <p class="menu-price">
                                                            <?php the_field('price'); ?> บาท
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="menu-type" id="breakfast">
                            ...
                            <div class="menu-slider">
                                <?php if ($breakfast->have_posts()): ?>
                                    <?php while ($breakfast->have_posts()):
                                        $breakfast->the_post(); ?>
                                        <div class="menu-item">
                                            <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>"
                                                class="menu-image" />
